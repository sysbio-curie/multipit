...
def main(params):
    ...
    *list_data, labels, target_surv = load_TIPIT_multimoda(
    ...
    pipe_clinical = (
        "clinicals",
        as_concordance_index_ipcw_scorer(clone(base_clf).set_params(**dct_clin_imput)),
    ...
    pipe_radiomics = (
        "radiomics",
        as_concordance_index_ipcw_scorer(clone(base_clf).set_params(**dct_rad_imput)),
        list(
    ...
    pipe_pathomics = (
        "pathomics",
        as_concordance_index_ipcw_scorer(clone(base_clf).set_params(**dct_pat_imput)),
        list(
            range(
    ...
    pipe_rna = (
        ...
        as_concordance_index_ipcw_scorer(
            Pipeline(
                steps=[("imputer_omics", CustomOmicsImputer(site_feature=-1))]
